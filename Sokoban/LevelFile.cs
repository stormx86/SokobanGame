...
namespace Sokoban
{
    class LevelFile
    {
        ...
        public Cell[,] LoadLevel(int levelNr)
        {
            Cell[,] cell = null;
            string[] lines;
            try
            ...
            {
                ReadLevelHeader(lines[curr], out currentLevelNumber, out width, out height);
                if (levelNr == currentLevelNumber)
                {
        ...
        public void SaveLevel(int levelNr, Cell[,] cell)
        {
            string[] lines;
            try
            {
            ...
            lines[curr] = levelNr.ToString() + " " + w.ToString() + " " + h.ToString();
